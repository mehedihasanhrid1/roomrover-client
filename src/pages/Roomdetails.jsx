          ...
          <div className="container px-6 pt-10 pb-8 lg:pb-12 lg:pt-14 mx-auto">
            <div className="lg:w-4/5 mx-auto flex flex-wrap">
              ...
              <div className="lg:w-1/2 w-full lg:pl-4 xl:pl-12 lg:py-6 mt-6 lg:mt-0">
                <h2 className="text-lg tracking-wider lg:text-xl font-semibold text-green-700 mb-3">
                  Available
                </h2>
                ...
                <div className="flex mb-4">
                  <div className="flex items-center">
                    ...
                    <p className="text-gray-700 text-lg font-medium dark:text-gray-300 ml-3 mr-1">
                      8 Reviews
                    </p>
                  </div>
                ...
                <p className="leading-relaxed">
                  Experience luxury in our executive suite. This spacious suite
                  offers a separate living area, a king-size bed, a
                  well-equipped kitchenette, and a stunning ocean view. Ideal
                  for a romantic getaway.
                </p>
                <p className="my-3 text-lg lg:text-xl font-bold">
                  Special Offers:{" "}
                  <span className="font-normal text-base lg:text-lg ml-1">
                    Book for 3 nights and get the 4th night free
                  </span>
                </p>
                <p className="my-3 text-lg lg:text-xl font-bold">
                  Room Size:{" "}
            ...
            <div className="flex flex-wrap py-4 mb-6 border-t border-b border-gray-200 dark:border-gray-700">
              <div className="w-full px-4 mb-4 lg:mb-0 md:w-1/4">
                <img
                  ...
                  src="https://lh3.googleusercontent.com/a/ACg8ocKWJDVT0493QEyxEy6cWb7J4Ak4J2iaTIY7XAkNKLOXxA=s96-c"
                  alt=""
                />
