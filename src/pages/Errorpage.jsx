          ...
          <div className="relative lg:pb-14 flex flex-col items-center justify-center">
            <div className="absolute">
              <div className="flex flex-col items-center justify-center text-center gap-4">
                ...
                <Link to='/'>                
                <button
                  className={`my-2 border-2 button-primary rounded-[40px] lg:text-sm xl:text-lg py-2.5 md:py-3 px-6 md:px-10 text-center font-semibold  focus:outline-none`}
                >Go Back
                </button></Link>
                <Link to='/'>                
                <button
                  className="my-2 border-2 rounded-[40px] lg:text-sm xl:text-lg py-2.5 md:py-3 px-4 md:px-8 text-center  font-semibold button-secondary focus:outline-none"
                >Report Problem
                </button></Link>
                </div>
              </div>
